...
export class LocationMasterAddComponent {
    ...
    orgCountry:any =[];
    filter:any ={}
    private searchInputChanged: Subject<string> = new Subject();
    
    ngOnInit() {
        this.orgData = this.authService.getOrg();
        this.orgCountry = this.orgData?.country || [];
    ...
    .subscribe(searchText => {
        this.CommonApiService.getStates(searchText, this.data.country)
    });
}
